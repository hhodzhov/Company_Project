# Company_Project
Да се напише програма, която да може да поддържа данните за служителите
...
● Името на проекта, по който работи в момента (името може да се
променя)
...
● Да се изведе информация за всички служители, които заемат дадена
длъжност
● Промяна на данни за служител
9
Приема се, че във фирмата постъпват организационни промени. Целият
персонал на фирмата се разделя на екипи. Всеки служител може да участва
точно в един екип. Възможно е да има екипи, в които не участват хора.
